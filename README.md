...
Only static version of the code works now, i.e. only zero temperature now.

1. Install at least ase-3.23.0b1. `pip install --upgrade git+https://gitlab.com/ase/ase.git@master`. Feb. 6. 2024.

2. Install this package with `pip install .`

3. Prepare inputs in a folder.

4. run `elastool_aims` in the folder.
