...
from elastool_aims.calc_elastic_elate import visualize_elastic_anisotropy,print_elastic_tensor
from elastool_aims.elate import ELATE
...
def sound_velocity(elastic_constants_dict, elastic_tensor, cwd, dimensional,latt_system,plotparameters,elateparameters):
    ...
    pos = ase.io.aims.read_aims_output("%s/OPT/aims.out"%cwd)
