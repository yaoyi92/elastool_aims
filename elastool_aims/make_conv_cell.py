...
def make_conventional_cell(file_name_read):
    ...
    elif "geometry.in" in file_name_read:
        input_file_format = 'aims'
    else:
        print('Please provide correct file name: .vasp or .cif or geometry.in')
        exit(1)
    ...
    elif input_file_format == 'aims':
        pos = read_aims("geometry.in")
